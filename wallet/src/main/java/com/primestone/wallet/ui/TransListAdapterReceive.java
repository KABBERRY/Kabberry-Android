...
public class TransListAdapterReceive extends BaseAdapter {
    ...
    @Deprecated
    public TransListAdapterReceive(final Context context, @Nonnull final AbstractWallet walletPocket) {
...
//        }
    ...
    private String resolveLabel(@Nonnull final AbstractAddress address) {
        final String cachedLabel = (String) this.labelCache.get(address);
        if (cachedLabel == null) {
