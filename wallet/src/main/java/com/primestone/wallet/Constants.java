...
public class Constants {
    ...
    public static final CoinType DEFAULT_COIN = PrimestoneMain.get();
    public static final List<CoinType> DEFAULT_COINS = ImmutableList.of((CoinType)PrimestoneMain.get());
    ...
    public static final String VERSION_URL = "http://primestone-explorer.com/getversion";
    static {
        COINS_ICONS = new HashMap<>();
        COINS_ICONS.put(CoinID.Primestone_MAIN.getCoinType(), R.drawable.app_launcher);
        COINS_BLOCK_EXPLORERS.put(CoinID.Primestone_MAIN.getCoinType(), "http://primestone-explorer.com/tx/%s");
    }
}
